  ...
  return (
    <div className="w-full h-[100vh] bg-gradient-to-t from-[black] to-[#030353] flex justify-center items-center flex-col p-[20px] ">
      <MdKeyboardBackspace
        ...
        onClick={() => navigate("/")}
      />
      <h1 className="text-white mb-[20px] mt-[20px] text-[30px] text-center ">
        Select your <span className="text-blue-200">Assistant Image</span>
      </h1>
      <div className="w-full h-[90%] max-w-[900px] flex justify-center items-center flex-wrap gap-[15px]">
        <Card image={image1} />
        <Card image={image2} />
        <Card image={image3} />
        <Card image={image4} />
      ...
      {selectedImage && (
        <button
          className="min-w-[150px] h-[60px] mt-[20px] mb-[30px] text-black font-semibold cursor-pointer  bg-white rounded-full text-[19px] "
